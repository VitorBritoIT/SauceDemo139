...
namespace MyNamespace
{
    ...
    public class StepDefinitions
    {
        ...
        public void QuandoAdicionoOProdutoAoCarrinho(string product)
        {
            ...
            // O nome do produto vem do arquivo. feature = Sauce Labs etc.
        ...
        {
            //Espera explícita pelo elemento span.title ser carregado na página
            ...
            //new WebDriverWait(driver, TimeSpan.FromMilliseconds(3000));  //Espera implícita
        ...
        public void EntaoNomeDoProduto(string productName)
        {
            Assert.That(driver.FindElement(By.CssSelector("div.inventory_item_name")).Text, Is.EqualTo(productName));
        }
